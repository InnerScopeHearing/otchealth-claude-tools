...
2026-06-16 21:47 | event-triage | GitHub notification: @COOINND added as owner of InnerScopeHearing org | CONFIRMED: repo transfer triggered it; git push revealed "This repository moved -> InnerScopeHearing/otchealth-claude-tools.git"; org owner auto-provisioned by GitHub; intentional; task updated; action needed: update repo references
2026-06-16 21:47 | calendar-workflow | blocked | COO: Read Calendar (xL0VYbElD15ttqKw) returned 404 — workflow not active on n8n self-host; calendar read unavailable this run; flagged to Matt
2026-06-16 21:47 | open-tasks-pulse | partial | Amazon TReO PDFs Needs Matt (sign 3 + upload, first-dollar gate); Gumroad SOPs generated awaiting Matt listing; reactivation email draft ready still unsent; OTCHealthMart cleanup dispatched
