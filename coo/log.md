...
2026-06-10 18:01 | event-mode: Matt email correction | done | Stripe is confirmed connected (not a remaining switch). FDA OTC Registration costs $11K/year not $10K, and is cash-gated (don't have $11K yet). Sequence corrected: earn $11K via Gumroad+email -> file FDA -> sell inventory. SITUATION.md, PRIORITIES.md, today.md all updated. COO task created to verify Shopify/Stripe link is live. Reply email queued for Matt. Moves 1+2 are now the ONLY path forward until $11K earned.
