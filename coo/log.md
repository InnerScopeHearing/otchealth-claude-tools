...
2026-06-24 14:07 | morning-guard | skipped | brief already sent today (marker "Morning brief sent - 2026-06-24" found in Notion). Notion also shows two "Needs Matt" tasks created today: Gumroad SOP publish + reactivation email approval. COO routine ran clean.
2026-06-24 14:08 | event-triage | needs-matt | GitHub email: Depot Code Access app requesting updated org permissions. Depot is the exclusive iOS build path (depot-macos-26). COO triaged only — not authorized to approve GitHub App permissions. Needs Matt to review and approve/deny via GitHub org settings before iOS CI is affected. Task created in Notion.
