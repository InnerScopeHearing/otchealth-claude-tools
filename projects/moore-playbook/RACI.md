...
|---|---|---|
| **OTCHealth Inc.** (operating company, the Reg D/CF/A+ issuer) | iHEAR TReO + the OTC hearing-aid line, iHEARtest, AWARE, InnerEase, OTCHealth Companion, MedReview (PHI-walled), the Shopify store (otchealthmart.com), CareNow/SaveRx (future, internal-only) | InnerScope's own public-company financials/stock; the personal-project apps below |
