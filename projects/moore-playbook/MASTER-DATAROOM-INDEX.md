...
| iHEAR TReO/Matrix (PSAP hardware, not apps), iHEARtest/AWARE/InnerEase/Companion (the app product suite), the AI voice sales channel, the funnel/growth engine | OTCHealth | `MOORE-PLAYBOOK.md`, `MOORE-PLAYBOOK-12MONTH.md` (CRO/CPO lanes), `medvi-operations/PLAN.md`, **`OTCHEALTH-APPS-DEEP-DIVE.md` (repo-verified pricing/market detail, new)** | CRO / CPO |
