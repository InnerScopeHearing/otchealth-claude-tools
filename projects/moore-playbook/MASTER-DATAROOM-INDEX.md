...
| iHEAR TReO (the PSAP), iHEAR Matrix/EAZE/STREAM/CONNECT/Linx/Axis (the OTC hearing aid line, FDA-registration-gated), iHEARtest/AWARE/InnerEase/Companion (the app product suite), the AI voice sales channel, the funnel/growth engine | OTCHealth | `MOORE-PLAYBOOK.md`, `MOORE-PLAYBOOK-12MONTH.md` (CRO/CPO lanes), `medvi-operations/PLAN.md`, **`OTCHEALTH-APPS-DEEP-DIVE.md` (repo-verified pricing/market/device-classification detail)** | CRO / CPO |
