...
# setup/openai-usage.mjs is now wired into every real OpenAI call site (chat/embedding/batch/image). Many of
...
# hydrated), that would send test-fixture-derived usage counts into PRODUCTION Datadog. This is a
