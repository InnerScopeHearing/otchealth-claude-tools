...
// reportCost() is a local console estimate. Provider usage receipts are recorded separately, at
// each successful raw API response, and never include this estimated dollar value.
