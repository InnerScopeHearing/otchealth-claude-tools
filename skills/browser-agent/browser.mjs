...
// The original word-boundary alternation is preserved intact as the first branch; the second branch
// adds real-world phrasings that slipped past it (red-team 2026-07-01): "card #", "CC number",
// "Agree & Sign", bare "e sign", and "<n>-digit code ... from your text". A false hit only PAUSES for
// a human (the safe direction), so slightly broader here is acceptable.
